...
async function handle(sock, messageInfo) {
    ...
    try {
        ...
        // Kirim ke API toCartoon
        const apiUrl = `https://anabot.my.id/api/ai/toCartoon?imageUrl=${encodeURIComponent(fileUrl)}&apikey=freeApikey`;
        ...
        const resultPath = path.join("tmp", `tocartoon_${Date.now()}.png`);
        ...
        console.error("❌ ERROR tocartoon2:", error);
        await sock.sendMessage(remoteJid, {
