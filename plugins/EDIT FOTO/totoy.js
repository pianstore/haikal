...
async function handle(sock, messageInfo) {
    ...
    try {
        ...
        // Panggil API
        const apiUrl = `https://anabot.my.id/api/ai/toToy?imageUrl=${encodeURIComponent(fileUrl)}&apikey=freeApikey`;
        ...
        const resultPath = path.join('tmp', `totoy_${Date.now()}.png`);
        ...
        console.error("❌ Error plugin totoy:", error.message);
        await sock.sendMessage(remoteJid, {
