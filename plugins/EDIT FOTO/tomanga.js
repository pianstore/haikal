...
async function handle(sock, messageInfo) {
    ...
    try {
        ...
        // Kirim ke API toManga
        const apiUrl = `https://anabot.my.id/api/ai/toManga?imageUrl=${encodeURIComponent(uploadedUrl)}&apikey=freeApikey`;
        ...
        const resultPath = path.join("tmp", `tomanga_${Date.now()}.png`);
        ...
        console.error("❌ ERROR plugin tomanga:", error);
        await sock.sendMessage(remoteJid, {
