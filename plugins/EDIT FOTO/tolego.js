...
async function handle(sock, messageInfo) {
    ...
    try {
        ...
        // Panggil API toLego
        const apiUrl = `https://anabot.my.id/api/ai/toLego?imageUrl=${encodeURIComponent(uploadedUrl)}&apikey=freeApikey`;
        ...
        const resultPath = path.join("tmp", `tolego_${Date.now()}.png`);
        ...
        console.error("❌ ERROR plugin tolego:", error);
        await sock.sendMessage(remoteJid, {
